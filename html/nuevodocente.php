  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="fas fa-user-plus"></i> REGISTRO DE DOCENTE</h1>
          <p>Bienvenido, para poder dar de alta a un docente a SIBITEC <i class="far fa-registered"></i> deberás llenar el siguiente formulario.</p>
          <p><i class="fas fa-exclamation"></i> Recuerda <i class="fas fa-exclamation"></i> para poder dar de alta, el docente debe contar con su credencial de la biblioteca.
          </p>
          <p>Ya que sólo ellos pueden solicitar préstamos externos.</p>
          <div class="underline">
          </div>
          <form action="../php/vDocente.php" method="POST" id="form_NDocente" onsubmit="return validarDocente()">
            <div class="telephone">
            ...
            <div class="submit">
              ...
              <input type="button" name="limpiar" value="Limpiar" onclick="limpiarDocente()" id="form_limpiar" />
            </div>
          </form>
      </div>
    </div>
...
<script src="../js/vDocente.js"></script>
