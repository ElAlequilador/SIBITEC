...
<head>
  ...
  <link rel="shortcut icon" href="../img/logo_sibitec.jpg" />
  ...
  <script src="https://kit.fontawesome.com/9f0a8b2bb7.js" crossorigin="anonymous"></script>
    ...
    function confirmDelete(){
      ...
      var respuesta= confirm("Estas seguro que deseas eliminar la Sección?");
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-book-reader"></i>ADMINISTRACIÓN DE SECCIONES</h1>
          <p>Bienvenido, en esta sección se encuentran todas las secciones registradas en SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada uno de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas una sección no podrás recuperar los datos.</p>
          <div class="underline">
          </div>
          
          <div style="overflow-y: scroll; height: 300px" class="container-table_s">
            <div class="table_title_s"><p>Seciones registradas en SIBITEC <i class="far fa-registered"></i></p></div>
            ...
            <div class="table_item_s">
              <a class="btn btn-success"  href="editSeccion.php?id=<?php echo $row["id_seccion"]; ?>"><i class="far fa-edit"></i> Editar </a>
              <a class="btn btn-danger" onclick="return confirmDelete()" href="../php/dSeccion.php?id=<?php echo $row["id_seccion"]; ?>"><i class="fas fa-trash-alt"></i> Eliminar </a>
            </div>
            <?php } ?>
          </div>
