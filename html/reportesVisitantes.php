...
<head>
  <!--TITULO, SCRIPTS -->
  <title>Reportes Visitantes</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../css/tabla_registros.css">
  ...
  <div class="row content">
    ...
    <div class="col-sm-12 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-clipboard"></i>REPORTES REGISTROS</h1>
          <p>Bienvenido, aqui se muestran a todos las cuentas de visitantes registradas en SIBITEC <i class="far fa-registered"></i>.</p>
          <div class="underline">
          </div>
          <br>
          <hr>
          ...
          <div 
         style="overflow-y: scroll; height: 300px" class="container-table_r">
            <div class="table_title_r">
              <p>Personas registrados en SIBTEC <i class="far fa-registered"></i></p>
            </div>
            <div class="table_header_r"><p>ID</p></div>
            <div class="table_header_r"><p>Nombre</p></div>
            <div class="table_header_r"><p>N° Control</p></div>
            <div class="table_header_r"><p>Carrera</p></div>
            <div class="table_header_r"><p>Edad</p></div>
            <div class="table_header_r"><p>Sexo</p></div>
            <div class="table_header_r"><p>Teléfono</p></div>
            <div class="table_header_r"><p>Correo</p></div>
            <div class="table_header_r"><p>Dominio</p></div>
            <div class="table_header_r"><p>Contraseña</p></div>
            <div class="table_header_r"><p>Fecha de Registro</p></div>

            <?php
            include "../php/conexion.php";
            $visitas = "SELECT * FROM registro ORDER BY nombre";
            $resultado = mysqli_query($obj_conexion, $visitas);

            while($row  = mysqli_fetch_assoc($resultado)){
            ?>
            <div class="table_item_r"><?php echo $row["id_registro"]; ?></div>
            <div class="table_item_r"><?php echo $row["nombre"]; ?></div>
            <div class="table_item_r"><?php echo $row["control"]; ?></div>
            <div class="table_item_r"><?php echo $row["carrera"]; ?></div>
            <div class="table_item_r"><?php echo $row["edad"]; ?></div>
            <div class="table_item_r"><?php echo $row["sexo"]; ?></div>
            <div class="table_item_r"><?php echo $row["telefono"]; ?></div>
            <div class="table_item_r"><?php echo $row["correo"]; ?></div>
            <div class="table_item_r"><?php echo $row["dominio"]; ?></div>
            <div class="table_item_r"><?php echo $row["password"]; ?></div>
            <div class="table_item_r"><?php echo $row["fecha_registro"]; ?></div>
    ...
    <div class="name">
      <form method="POST" action="../php/reporteVisitantes.php">
    ...
    <div class="email">
      <form method="POST" action="../php/pdfVisitantes.php">
