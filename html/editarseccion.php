  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="fas fa-user-edit"></i>EDITAR SECCION</h1>
          <p>Bienvenido a  editar SECCION, una vez realizadoS los cambios presiona "Guardar".</p>
          <div class="underline">
          </div>
          
            <form action="../php/aSeccion.php" method="POST" id="form_ESeccion" onsubmit="return validarEAlumno()">
            <?php
                ...
                $var_select = "SELECT * FROM secciones WHERE id_seccion = '$id_seccion'";
                ...
                <div class="telephone">
                    ...
                    <input type="text" value="<?php echo $row["id_seccion"]; ?>" name="id_seccion" 
                    id="id_seccion" hidden="">
                </div>
                
                <div class="telephone">
                    <label for="email"><p>Nombre de la Sección</p></label>
                    <input type="text" value="<?php echo $row["nombre"]; ?>" name="nombre" id="nombre">
                </div>
                
                <div class="telephone">
                    <label for="email"><p>Categoría de la Sección</p></label>
                    <input type="text" value="<?php echo $row["categoria"]; ?>" name="categoria" id="categoria" disabled="">
                </div>
                
                <div class="telephone">
                    <label for="email"><p>Fecha de Registro</p></label>
...
<script src="../js/vESeccion.js"></script>
