...
<html lang="es">
<head>
  <title>Nuevo Motivo de Entrada</title>
  <meta charset="utf-8">
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-comments"></i> NUEVO MOTIVO DE ENTRADA</h1>
          <p>Bienvenido, en esta sección podrás agregar un nuevo motivo de entrada al SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Para añadir el motivo de entrada debes llenar el siguiente forumulario.</p>
          <div class="underline">
          </div>
          <form action="../php/vNMotivo.php" method="POST" id="form_motivo" onsubmit="return validarMotivo()">
            <div class="text">
              <label for="name"></label>
              <input type="text" placeholder="Nombre del Motivo" name="motivo" id="motivo">
            </div>
            <input type="text" disabled="">
            <div class="submit">
              <input type="submit" value="Guardar" onclick="return confirmInsert()" name="guardar" 
              id="form_enviar" />
              <input type="button" onclick="limpiarMotivo()" value="Limpiar" id="form_limpiar" />
            </div>
          </form>
      </div>
    </div>
...
<script src="../js/vNMotivo.js"></script>
