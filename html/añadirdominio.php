  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="fas fa-at"></i> NUEVO DOMINIO</h1>
          <p>Bienvenido, en esta sección podrás agregar un nuevo dominio al SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Para añadir el dominio debes llenar el siguiente forumulario.</p>
          <div class="underline">
          </div>
          <form action="../php/vNDominio.php" method="POST" id="form_motivo" onsubmit="return validarMotivo()">
            <div class="text">
              <label for="name">@ejemplo.com</label>
              <input type="text" placeholder="@dominio.com" name="dominio" id="dominio">
            </div>
            <div class="submit">
              <input type="submit" onclick="return confirmInsert()" value="Guardar" name="guardar" 
              id="form_enviar" />
