...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-3 sidenav">
     ...
     <form method="POST" action="../php/reporteCategorias.php">
    ...
    <div class="col-sm-6 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-clipboard"></i>REPORTES CATEGORIAS</h1>
          <p>Bienvenido, aqui se muestran a todos las categorías registradas en SIBITEC <i class="far fa-registered"></i>.</p>
          ...
          <div style="overflow-y: scroll; height: 300px" class="container-table_c">
            <div class="table_title_c"><p>Categorias registradas en SIBTEC <i class="far fa-registered"></i></p>
            </div>
           ...
           <?php
            ...
            <div class="table_item_c">
              <a class="btn btn-success"  href="editarcategoria.php?id=<?php echo $row["id_categoria"]; ?>">
    ...
    <div class="col-sm-3 sidenav">
      <!-- FORMULARIO PARA GENERAR UN DOCUMENTO .PDF A PARTIR DE UN RANGO DE FECHAS -->
       <form method="POST" action="../php/pdfCategorias.php">
