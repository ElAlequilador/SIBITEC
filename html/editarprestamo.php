  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
        ...
        <p>Bienvenido, selecciona a quien le editarás el préstamo.</p>
        <div class="underline">
        </div>
        <br>
        <br>
        <div>
            <a id="form_enviar" href="editarprestamoA.php" name="buscar">Alumno <i class="fas fa-user-graduate"></i></a>
            <a id="form_enviar" href="editarprestamoD.php" name="buscar">Docente <i class="fas fa-chalkboard-teacher"></i></a>
            <a id="form_enviar" href="editarprestamoU.php" name="buscar">Usuario <i class="fas fa-user-tie"></i></a>
        </div>
      </div>
    </div>
    <!-- FECHA Y HORA -->
