...
<?php
  ...
  $fechaE = $_POST['fechaE'];
  $fechaS = $_POST['fechaS'];
  $var_select = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS')";
  $query = mysqli_query($obj_conexion,$var_select);
  $res = mysqli_num_rows($query);

  $var_ISC = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_IM = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
             AND (carrera = 'Ing. Mecanica')";
  $query_IM = mysqli_query($obj_conexion,$var_IM);
  $res_IM = mysqli_num_rows($query_IM);
  $totIM = $res_IM*100/$res;

  $var_IIL = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_MCB = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_MII = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_MISC = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_DCB = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
  ...
  $var_O = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
            AND (carrera = 'Otro')";
...
<?php
  require('../php/conexion.php');
  $var_selectS = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS')";
  $queryS = mysqli_query($obj_conexion,$var_selectS);
  $resS = mysqli_num_rows($queryS);

  $var_SM = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
             AND (sexo = 'Masculino')";
  $query_SM = mysqli_query($obj_conexion,$var_SM);
  $res_SM = mysqli_num_rows($query_SM);
  $totSM = $res_SM*100/$resS;

  $var_SF = "SELECT * FROM registro WHERE (fecha_registro BETWEEN '$fechaE' AND '$fechaS') 
             AND (sexo = 'Femenino')";
...
<head>
  <!--TITULO, SCRIPTS -->
  <title>Estadísticas Registros</title>
  <meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Gráfico Registros en SIBITEC por CARRERAS'
      };

      var chart = new google.visualization.PieChart(document.getElementById('piechart_Registros'));
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Gráfico Registros en SIBITEC por SEXO'
      };

      var chart = new google.visualization.PieChart(document.getElementById('piechart_Registros_Sexo'));
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
       <h1>&bull; SIBITEC &bull;</h1>
          <h1><i class="fas fa-chart-pie"></i>ESTADÍSTICAS REGISTROS</h1>
          <div id="piechart_Registros" style="max-width:100%;height:auto;"></div>
          <hr>
          <div id="piechart_Registros_Sexo" style="max-width:100%;height:auto;"></div>
          <hr>
    </div>
    <!-- FECHA Y HORA -->
  </div>
