  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-bookmark"></i>NUEVA CATEGORÍA</h1>
          <p>Bienvenido, para añadir una nueva categoría a SIBITEC <i class="far fa-registered"></i> deberás llenar el siguiente formulario.</p>
          <p><i class="fas fa-exclamation"></i> Recuerda <i class="fas fa-exclamation"></i> que una categoría es una pequeña área donde se ubican los libros.</p>
          <div class="underline">
          </div>
          <form action="../php/vNCategoria.php" method="POST" id="form_categoria" 
          onsubmit="return validarCategoria()">
            <div class="text">
              <label for="name"></label>
              <input type="text" placeholder="Nombre de la Categoría" name="nombre" id="nombre_categoria">
            </div>
            <div class="submit">
...
<script src="../js/vCategoria.js"></script>
