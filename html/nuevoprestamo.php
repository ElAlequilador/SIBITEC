  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
        ...
        <p>Bienvenido, selecciona a quien solicitó el préstamo.</p>
        <div class="underline">
        </div>
        <br>
        <br>
        <div>
            <a id="form_enviar" href="prestamoalumno.php" name="buscar">Alumno <i class="fas fa-user-graduate"></i></a>
            <a id="form_enviar" href="prestamodocente.php" name="buscar">Docente <i class="fas fa-chalkboard-teacher"></i></a>
            <a id="form_enviar" href="prestamousuario.php" name="buscar">Usuario <i class="fas fa-user-tie"></i></a>
        </div>
      </div>
    </div>
    <!-- FECHA Y HORA -->
