  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-edit"></i>EDITAR CARRERA</h1>
          <p>Bienvenido, para editar una carrera debes llenar el siguiente formulario.</p>
          <div class="underline">
          </div>
          <br>
          
            <form action="../php/uCarrera.php" method="POST" id="form_EditCategoria" onsubmit="return validarEditCategoria()">
            <?php
                ...
                $var_select = "SELECT * FROM carreras WHERE id_carrera = '$id_carrera'";
                ...
                <div class="telephone"> 
                    ...
                    <input type="text" value="<?php echo $row["id_carrera"]; ?>" name="id_carrera" 
                    id="id_carrera" hidden="">
                </div>
...
<script src="../js/vEditCategoria.js"></script>
