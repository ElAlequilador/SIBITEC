...
<head>
  ...
  <link rel="stylesheet" href="../css/tabla_carreras.css">
  <script src="https://kit.fontawesome.com/9f0a8b2bb7.js" crossorigin="anonymous"></script>
  <script type="text/javascript">
    function confirmDelete(){

      var respuesta= confirm("Estas seguro que deseas eliminar la Carrera?");
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-sliders-h"></i> ADMINISTRACIÓN DE CARRERAS</h1>
          <p>Bienvenido, en esta sección podrás ver todas las carreras del TecNM, Campus Victoria que están registradas en SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada una de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas una carrera no podrás recuperar los datos.</p>
          <div class="underline">
          </div>


          <div style="overflow-y: scroll; height: 300px" class="container-table_c">
            <div class="table_title_c">
              <p>Carreras registradas en SIBITEC <i class="far fa-registered"></i></p>
            </div>
            <div class="table_header_c"><p>ID</p></div>
            <div class="table_header_c"><p>Nombre</p></div>
            <div class="table_header_c"><p>Fecha de Registro</p></div>
            <div class="table_header_c"><p>Operación</p></div>

            <?php
            include "../php/conexion.php";
            $categoria = "SELECT * FROM carreras ORDER BY nombre";
            $resultado = mysqli_query($obj_conexion, $categoria);

            while($row  = mysqli_fetch_assoc($resultado)){
            ?>
            <div class="table_item_c"><?php echo $row["id_carrera"]; ?></div>
            <div class="table_item_c"><?php echo $row["nombre"]; ?></div>
            <div class="table_item_c"><?php echo $row["fecha_registro"]; ?></div>
            <div class="table_item_c">
              <a class="btn btn-success"  href="editCarrera.php?id=<?php echo $row["id_carrera"]; ?>"><i class="far fa-edit"></i> Editar </a>
              <a class="btn btn-danger" onclick="return confirmDelete()" 
              href="../php/dCarrera.php?id=<?php echo $row["id_carrera"]; ?>"><i class="fas fa-trash-alt"></i> Eliminar </a>
            </div>
