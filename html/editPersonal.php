  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <p>Bienvenido, para editar un usuario debes llenar el siguiente formulario.</p>
          <p><i class="fas fa-exclamation"></i> Recuerda que Rol "1" es para administradores y Rol "2", para personal administrativo.</p>
          <div class="underline">
          </div>
          <br>
          
            <form action="../php/uUsuario.php" method="POST" id="form_EAlumno" onsubmit="return validarEAlumno()">
            <?php
                require("../php/conexion.php");
                require("../php/funcionesLimpieza.php");

                $id_usuario = valida_input($_GET['id']);
                $var_select = "SELECT * FROM usuarios WHERE id_usuario = '$id_usuario'";
                ...
                <div class="telephone"> 
                    ...
                    <input type="text" value="<?php echo $row["id_usuario"]; ?>" name="id_usuario" 
                    id="id_usuario" hidden="">
                </div>
                <div class="telephone">
                ...
                <div class="name">
                    <label for="name"><p>Control / Clave</p></label>
                ...
                <div class="name">
                    ...
                    <input type="text" value="<?php echo $row["usuario"]; ?>" name="usuario" id="usuario">
                </div>
                <div class="email">
                    <label for="name"><p>Contraseña</p></label>
                    <input type="text" value="<?php echo $row["password"]; ?>" name="contraseña" id="contraseña">
                </div>
                <div class="name">
                    <label for="name"><p>Rol</p></label>
                    <input type="text" value="<?php echo $row["rol"]; ?>" name="rol" id="rol">
                </div>
                <div class="email">
