...
<head>
  ...
  <script type="text/javascript">
    function confirmUpdate(){
      ...
      var respuesta= confirm("Los cambios son correcos?");
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-edit"></i>EDITAR DOMINIO</h1>
          <p>Bienvenido, para editar un dominio debes llenar el siguiente formulario.</p>
          <div class="underline">
          </div>
          <br>
          
            <form action="../php/uDominio.php" method="POST" id="form_EditMotivo" onsubmit="return validarEditMotivo()">
            <?php
                ...
                $var_select = "SELECT id_dominio, nombre FROM dominios WHERE id_dominio = '$id_dominio'";
                ...
                <div class="name"> 
                    ...
                    <input type="text" value="<?php echo $row["id_dominio"]; ?>" name="id_dominio" 
                    id="id_dominio" hidden="">
                </div>
                <div class="telephone">
                    <label for="name"><p>Nombre del Dominio</p></label>
                ...
                <div class="submit">
                  <input type="submit" name="guardar" onclick="return confirmUpdate()" value="Guardar" 
                  id="form_enviar" />
...
<script src="../js/vEditMotivo.js"></script>
