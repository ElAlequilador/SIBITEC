  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
        ...
        <p>Bienvenido, para editar el préstamo del usuario sólo debes agregar una nueva fecha de entrega.
        </p>
        <div class="underline">
        </div>
          
        <form action="../php/uPrestamoU.php" method="POST" id="form_ELibro" onsubmit="return validarELibro()">
          <?php
            ...
            $var_select = "SELECT * FROM prestamos_usuarios WHERE id_prestamo = '$id'";
