  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-edit"></i>EDITAR SECCIÓN</h1>
          <p>Bienvenido, una vez realizados los cambios guardalos.</p>
          <div class="underline">
          </div>
          <br>
          
            <form action="../php/uSeccion.php" method="POST" id="form_ESeccion" onsubmit="return validarEAlumno()">
            <?php
...
<script src="../js/vEditSeccion.js"></script>
