  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-clipboard"></i>REPORTE USUARIO</h1>
          <p>Bienvenido aquí generarás un reporte detallado del usuario.</p>
          <div class="underline">
          </div>
          
            <form action="../php/rUsuario.php" method="POST" id="form_EAlumno" onsubmit="return validarEAlumno()">
            <?php
                ...
                $var_select = "SELECT * FROM prestamos_usuarios WHERE id_prestamo = '$id_prestamo'";
