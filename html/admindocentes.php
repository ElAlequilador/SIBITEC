...
<head>
  ...
  <link rel="shortcut icon" href="../img/logo_sibitecs.jpg" />
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-user-tie"></i> ADMINISTRAR DOCENTES</h1>
          <p>Bienvenido, en esta sección podrás ver a todos los docentes registrados por el personal administrativo a SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada uno de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas un docente no podrás recuperar los datos.</p>
          <div class="underline">
          </div>

          <div style="overflow-y: scroll; height: 300px" class="container-table_d">
            <div class="table_title_d"><p>Docentes registrados en SIBITEC <i class="far fa-registered"></i></p></div>
            ...
            <div class="table_header_d"><p>Telefono</p></div>
            ...
            <div class="table_item_d">
              <a class="btn btn-success" href="editDocente.php?id=<?php echo $row["id_docente"]; ?>"><i class="fas fa-trash-alt"></i> Editar </a>
