...
<html lang="es">
<head>
  <title>Administrar Motivos de Entrada</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../css/tabla_motivos.css">
  <script src="https://kit.fontawesome.com/9f0a8b2bb7.js" crossorigin="anonymous"></script>
    <script type="text/javascript">
    function confirmDelete(){

      var respuesta = confirm("Estas seguro que deseas eliminar el Motivo de Entrada?");
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
          ...
          <h1><i class="far fa-comments"></i> ADMINISTRACIÓN DE MOTIVOS DE ENTRADA</h1>
          <p>Bienvenido, en esta sección encontrarás todos los motivos de entrada registrados en SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada uno de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas un motivo de entrada no podrás recuperar los datos.</p>
          <div class="underline">
          </div>


          <div style="overflow-y: scroll; height: 300px" class="container-table_m">
            <div class="table_title_m">
              <p>Motivos de entrada registrados en SIBITEC <i class="far fa-registered"></i></p>
            </div>
            <div class="table_header_m"><p>ID</p></div>
            <div class="table_header_m"><p>Nombre</p></div>
            <div class="table_header_m"><p>Fecha de Registro</p></div>
            <div class="table_header_m"><p>Operación</p></div>

            <?php
            include "../php/conexion.php";
            $categoria = "SELECT * FROM motivos_entrada";
            $resultado = mysqli_query($obj_conexion, $categoria);

            while($row  = mysqli_fetch_assoc($resultado)){
            ?>
            <div class="table_item_m"><?php echo $row["id_motivo"]; ?></div>
            <div class="table_item_m"><?php echo $row["nombre"]; ?></div>
            <div class="table_item_m"><?php echo $row["fecha_registro"]; ?></div>
            <div class="table_item_m">
              <a class="btn btn-success"  href="editMotivo.php?id=<?php echo $row["id_motivo"]; ?>"><i class="far fa-edit"></i> Editar </a>
              <a class="btn btn-danger"  onclick="return confirmDelete()" href="../php/dMotivo.php?id=<?php echo $row["id_motivo"]; ?>"><i class="fas fa-trash-alt"></i> Eliminar </a>
            </div>
