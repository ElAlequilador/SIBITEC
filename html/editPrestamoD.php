  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
        ...
        <p>Bienvenido, para editar el préstamo del docente sólo debes agregar una nueva fecha de entrega.
        </p>
        <div class="underline">
        </div>
          
        <form action="../php/uPrestamoD.php" method="POST" id="form_ELibro" onsubmit="return validarELibro()">
          <?php
            ...
            $resultado = mysqli_query($obj_conexion, "SELECT * FROM prestamos_docentes WHERE id_prestamo = '$id'");
