  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-clipboard"></i>REPORTE DOCENTE</h1>
          <p>Bienvenido aquí generarás un reporte detallado del docente.</p>
          <div class="underline">
          </div>
          
            <form action="../php/rDocente.php" method="POST" id="form_EAlumno" onsubmit="return validarEAlumno()">
            <?php

                require("../php/conexion.php");
                require("../php/funcionesLimpieza.php");

                $id_prestamo = valida_input($_GET['id']);
                $var_select = "SELECT * FROM prestamos_docentes WHERE id_prestamo = '$id_prestamo'";
                ...
                <div class="telephone">
                    ...
                    <input type="text" value="<?php echo $row["id_prestamo"]; ?>" name="id_prestamo" id="id_prestamo" hidden="">
                </div>

                <div class="telephone">
                    <label for="name"><p>Titulo</p></label>
                    <input type="text" value="<?php echo $row["titulo"]; ?>" name="titulo" id="titulo">
                </div>

                <div class="telephone">
                    <label for="name"><p>Autor</p></label>
                    <input type="text" value="<?php echo $row["autor"]; ?>" name="autor" id="autor">
                </div>
                ...
                <div class="email">
                    <label for="name"><p>Docente</p></label>
                    <input type="text" value="<?php echo $row["nombre"]; ?>" name="nombre" id="nombre">
                </div>

                <div class="name">
                    <label for="name"><p>Fecha de Salida</p></label>
                    <input type="text" value="<?php echo $row["fecha_salida"]; ?>" name="fecha_salida" id="fecha_salida">
                </div>

                <div class="email">
                    <label for="name"><p>Fecha de Entrega</p></label>
                    <input type="text" value="<?php echo $row["fecha_entrega"]; ?>" name="fecha_entrega" id="fecha_entrega">
                </div>

                <input type="text" disabled="">

                <div class="submit">
                  <input type="submit" name="guardar" value="Generar Reporte" id="form_enviar" />
                </div>
                <?php 
...
<!--<script src="../js/vEAlumno.js"></script>-->
