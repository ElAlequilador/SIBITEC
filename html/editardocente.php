  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <p>Bienvenido a la sección de editar docente, una vez realizado los cambios presiona "Guardar".</p>
          <div class="underline">
          </div>
          
            <form action="../php/aDocente.php" method="POST" id="form_EDocente" onsubmit="return validarEDocente()">
            <?php
...
<script src="../js/vEDocente"></script>
