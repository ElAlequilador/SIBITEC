...
<head>
  ...
  <script src="https://kit.fontawesome.com/9f0a8b2bb7.js" crossorigin="anonymous"></script>
    ...
    function confirmDelete(){
      ...
      var respuesta= confirm("Estas seguro que deseas eliminar la Categoría?");
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div>
          ...
          <h1><i class="far fa-bookmark"></i> ADMINISTRACIÓN DE CATEGORÍAS</h1>
          <p>Bienvenido, en esta sección se encuentran todas las categorías registradas en SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada uno de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas una categoría no podrás recuperar los datos.</p>
          <div class="underline">
          </div>


          <div style="overflow-y: scroll; height: 300px" class="container-table_c">
            <div class="table_title_c"><p>Categorias registradas en SIBITEC <i class="far fa-registered"></i></p></div>
            ...
            ?>
            <div class="table_item_c"><?php echo $row["id_categoria"]; ?></div>
            ...
            <div class="table_item_c">
              <a class="btn btn-success" href="editCategoria.php?id=<?php echo $row["id_categoria"]; ?>"><i class="far fa-edit"></i> Editar </a>
              <a class="btn btn-danger" onclick="return confirmDelete()" href="../php/dCategoria.php?id=<?php echo $row["id_categoria"]; ?>"><i class="fas fa-trash-alt"></i> Eliminar </a>
            </div>
