  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="fas fa-user-edit"></i>EDITAR DOCENTE</h1>
          <p>Bienvenido, una vez realizados los cambios guardalos.</p>
          <div class="underline">
          </div>
          
            <form action="../php/uDocente.php" method="POST" id="form_EDocente" onsubmit="return validarEDocente()">
            <?php
                ...
                $var_select = "SELECT * FROM docentes WHERE id_docente = '$id_docente'";
                ...
                <div class="telephone">
                    ...
                    <input type="text" value="<?php echo $row["id_docente"]; ?>" name="id_docente" 
                    id="id_docente" hidden="">
                </div><br>
...
<script src="../js/vEditDocente.js"></script>
