  ...
  <div class="row content">
    ...
    <div class="col-sm-12 text-center"> 
      <div>
          ...
          <h1><i class="fas fa-users"></i> ADMINISTRAR ALUMNOS</h1>
          <p>Bienvenido, en esta sección podrás ver a todos los alumnos registrados por personal administrativo a SIBITEC <i class="far fa-registered"></i>.</p>
          <p>Puedes gestionar a cada uno de ellos en el apartado "Operación" de la tabla.</p>
          <p><i class="fas fa-exclamation-circle"></i> Cuidado, si eliminas un alumno no podrás recuperar los datos.</p>
          <div class="underline">
          </div>

          <div 
         style="overflow-y: scroll; height: 300px" class="container-table_a">
            <div class="table_title_a"><p>Alumnos registrados en SIBITEC <i class="far fa-registered"></i></p></div>
            ...
            <div class="table_header_a"><p>Telefono</p></div>
            <div class="table_header_a"><p>Correo</p></div>
            <div class="table_header_a"><p>Dominio</p></div>
            <div class="table_header_a"><p>Fecha de Registro</p></div>
            ...
            <div class="table_item_a">
              <a class="btn btn-success"  href="editAlumno.php?id=<?php echo $row["id_alumno"]; ?>"><i class="far fa-edit"></i> Editar </a>
