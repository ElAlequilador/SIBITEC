<?php
  // VERIFICAMOS SI YA SE HA INICIADO SESIÓN, DE LO CONTRARIO NO PODRÁ TENER ACCESO A LA PÁGINA
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="fas fa-book-reader"></i>NUEVA SECCIÓN</h1>
          <p>Bienvenido, para añadir una nueva sección a SIBITEC <i class="far fa-registered"></i> deberás llenar el siguiente formulario.</p>
          <p><i class="fas fa-exclamation"></i> Recuerda <i class="fas fa-exclamation"></i> que una sección es el número de estante donde se ubican libros y que pertenecen a una pequeña área (Categoría).</p>
          <div class="underline">
          </div>
          <form action="../php/vNSeccion.php" method="POST" id="form_seccion" onsubmit="return validarSeccion()">
            <div class="text">
              <label for="name"></label>
              <input type="text" placeholder="Nombre de la Sección" name="nombre" id="nombre_seccion">
            </div>
            <div class="subject">
              ...
              <select placeholder="Categoria" name="categoria" id="categoria">
                ...
                <?php
                  ...
                  $categoria = "SELECT * FROM categorias ORDER BY nombre";
            ...
            <div class="submit">
              ...
              <input type="button" onclick="limpiarSeccion()" value="Limpiar" id="form_limpiar" />
            </div>
          </form>
      </div>
    </div>
...
<script src="../js/vSeccion.js"></script>
