  ...
  <div class="row content">
    <div class="col-sm-12 text-center"> 
      <div>
          ...
          <p>Bienvenido, para editar un prestamo deberás ingresar el nombre del usuario que solicitó el préstamo para buscarlo en SIBITEC 
            <i class="far fa-registered"></i>.
          </p>
          <p>En la tabla se muestran los prestamos que el usuario ha solicitado y no ha devuelto.</p>
         ...
         style="overflow-y: scroll; height: 300px" class="container-table_p">
            <div class="table_title_p">
              <p>Préstamos pendientes del Usuario registrados en SIBITEC <i class="far fa-registered"></i></p>
            </div>
            ...
            if (isset($_POST['buscar'])) {
              if (strlen($_POST['nombre']) >= 1) {
                ...
                $prestamo = "SELECT * FROM prestamos_usuarios WHERE nombre LIKE '%$nombre%'
            ...
            <div class="table_item_p">
              <a class="btn btn-success"  href="editPrestamoU.php?id=<?php echo $row["id_prestamo"]; ?>"><i class="far fa-edit"></i> Editar </a>
