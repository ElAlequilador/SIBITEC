  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-clipboard"></i>REPORTE ALUMNO</h1>
          <p>Bienvenido aquí generarás un reporte detallado del alumno.</p>
          <div class="underline">
          </div>
          
            <form action="../php/rAlumno.php" method="POST" id="form_EAlumno" onsubmit="return validarEAlumno()">
            <?php
                ...
                $var_select = "SELECT * FROM prestamos_alumnos WHERE id_prestamo = '$id_prestamo'";
