  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <p>Bienvenido, aquí podrás editar la infromación del alumno.</p>
          <p>Una vez realizado los cambios presiona "Guardar".</p>
          <div class="underline">
          </div>
          
            <form action="../php/aAlumno.php" method="POST" id="form_EAlumno" onsubmit="return validarEAlumno()">
            <?php
                ...
                <div class="name">
                    <label for="name"><p>Carrera</p></label>
                    <input type="text" value="<?php echo $row["carrera"]; ?>" name="carrera" id="carrera">
                </div>
