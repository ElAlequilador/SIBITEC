  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
        ...
        <p>Una vez corroborados los datos, buscarás el nombre del usuario en la lista desplegable.</p>
        ...
        <form method="POST" action="../php/vNPrestamoU.php" id="prestamo_form" name="Formulario_Prestamo">
            ...
            <div class="subject">
              ...
              <select  name="nombre" id="nombre" style="font-size: 17px;">
                <option disabled hidden selected>Selecciona Usuario</option>
                <?php
                  include "../php/conexion.php";
                  $motivo = "SELECT nombre FROM usuarios ORDER BY nombre";
