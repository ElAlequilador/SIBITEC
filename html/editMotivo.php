...
<html lang="en">
<head>
  <title>Editar Motivo de Entrada</title>
  <meta charset="utf-8">
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
          ...
          <h1><i class="far fa-edit"></i>EDITAR MOTIVO DE ENTRADA</h1>
          <p>Bienvenido, para editar un motivo de entrada debes llenar el siguiente formulario.</p>
          <div class="underline">
          </div>
          <br>
          
            <form action="../php/uMotivo.php" method="POST" id="form_EditMotivo" onsubmit="return validarEditMotivo()">
            <?php
                ...
                $var_select = "SELECT * FROM motivos_entrada WHERE id_motivo = '$id_motivo'";
                ...
                <div class="telephone"> 
                    ...
                    <input type="text" value="<?php echo $row["id_motivo"]; ?>" name="id_motivo" id="id_motivo" hidden="">
                </div>
