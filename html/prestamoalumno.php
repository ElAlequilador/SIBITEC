  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      <div id="container">
        ...
        <p>Una vez corroborados los datos, buscarás el nombre del alumno en la lista desplegable.</p>
        ...
        <form method="POST" action="../php/vNPrestamoA.php" id="prestamo_form" name="Formulario_Prestamo">
            ...
            if (isset($_POST['buscar'])) {
              if (strlen($_POST['folio']) >= 1) {
                ...
                $var_select = "SELECT folio, titulo, editorial, autores, seccion, categoria FROM libros 
                WHERE folio = '$folio'";
            ...
            <div class="subject">
              ...
              <select  name="nombre" id="nombre" style="font-size: 17px;">
                <option disabled hidden selected>Selecciona Alumno</option>
                <?php
                  include "../php/conexion.php";
                  $motivo = "SELECT nombre FROM alumnos ORDER BY nombre";
