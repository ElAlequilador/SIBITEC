...
function Header()
{
    ...
    $this->Cell(70,8,'',0);
    $this->Cell(50,8,'Reporte de Alumnos ',0,0,'C');
    $this->Ln(8);
    $this->Ln(15);
...
$var_select = "SELECT nombre, control, carrera, edad, sexo, telefono, correo, dominio 
               FROM alumnos
...
$pdf->SetFont('Arial','',8);
//$this->Cell(70,8,'',0);
$pdf->Cell(80,8,'Alumnos registrados en SIBITEC del ' . $fechaE . ' Al '. $fechaS ,0,0,'C');
$pdf->Ln(8);
...
$var_ISC = "SELECT * FROM alumnos WHERE carrera = 'Ing. Sistemas Computacionales' 
            AND fecha_registro BETWEEN '$fechaE' AND '$fechaS' ";
$query_ISC = mysqli_query($obj_conexion,$var_ISC);
$res_ISC = mysqli_num_rows($query_ISC);

$var_ISCM = "SELECT * FROM alumnos WHERE carrera = 'Ing. Sistemas Computacionales' 
...
$var_ISCF = "SELECT * FROM alumnos WHERE carrera = 'Ing. Sistemas Computacionales' 
...
$pdf->Ln(5);
$pdf->Cell(139,8,utf8_decode('Carrera: Ing. Electrónica, se registraron ') . $res_IE . ' de los cuales '. $res_IEF . ' son mujeres ' . ' y ' . $res_IEM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
...
$pdf->Ln(5);
$pdf->Cell(155,8,utf8_decode('Carrera: Ing. Energías Renovables, se registraron ') . $res_IER . ' de los cuales '. $res_IERF . ' son mujeres ' . ' y ' . $res_IERM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
$pdf->Cell(153,8,utf8_decode('Carrera: Ing. Gestión Empresarial, se registraron ') . $res_IGE . ' de los cuales '. 
    $res_IGEF . ' son mujeres ' . ' y ' . $res_IGEM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
$pdf->Cell(138,8,utf8_decode('Carrera: Ing. Informática, se registraron ') . $res_II . ' de los cuales '. $res_IIF . ' son mujeres ' . ' y ' . $res_IIM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
$pdf->Cell(136,8,utf8_decode('Carrera: Ing. Mecánica, se registraron ') . $res_IM . ' de los cuales '. $res_IMF . ' son mujeres ' . ' y ' . 
    $res_IMM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
$pdf->Cell(133,8,utf8_decode('Carrera: Lic. Biología, se registraron ') . $res_LB . ' de los cuales '. $res_LBF . ' son mujeres ' . ' y ' . 
    $res_LBM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
$pdf->Cell(155,8,utf8_decode('Carrera: Maestría en Ing. Industrial, se registraron ') . $res_MII . ' de los cuales '. $res_MIIF . ' son mujeres ' . ' y ' . $res_MIIM .' son hombres. ' ,0,0,'C');
$pdf->Ln(5);
